...
class LFM(torch.nn.Module):
    def __init__(self, n_users, n_items, social_user, n_factors=10, dropout_p=0.02, lr=0.01, weight_decay=0.,alpha=0.8, sparse=False):

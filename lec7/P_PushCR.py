...
parser.add_argument('--p', type=int, default=1, help='lp范数')
parser.add_argument('--neg_count', type=int, default=100, help='负样本数')
opt = parser.parse_args()


if __name__ == '__main__':
    model = PPushCR("../data/ml-100k/u.data", n_factors=opt.n_factors, lr=opt.lr, topn=opt.topn,
                weight_decay=opt.weight_decay, batch_size=opt.batch_size,p=opt.p,neg_count=opt.neg_count)
